...
class Task(object):
    def __init__(self, name="", user="", description=u'Описание отсутствует', is_done=False, date='',
    ...
    def from_dict(source):
        task = Task(source[u'name'], source[u'user'], source[u'description'], source[u'is_done'], source[u'date'],
                    source[u'is_send_message'])
        return task
